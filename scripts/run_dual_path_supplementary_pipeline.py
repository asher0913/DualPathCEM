...
RESULTS_ROOT = ROOT / "outputs" / "dual_path_supplementary"
MAIN_RESULTS_ROOT = ROOT / "outputs" / "dual_path_publication"
PAPER_OUTPUT = ROOT / "outputs" / "paper_assets" / "dual_path_supplementary"
LOG_ROOT = ROOT / "outputs" / "logs" / "dual_path_supplementary"
STATE_PATH = ROOT / "outputs" / "state" / "dual_path_supplementary.json"
...
def main() -> None:
    ...
    if args.stage in ("aggregate", "all"):
        aggregate_results(state, state_path, args.attempts, args.retry_seconds)
    state["status"] = "PASS"
        ...
        json.dumps(
            {
                ...
                "derived_assets": str(PAPER_OUTPUT),
            },
            sort_keys=True,
        ),
        flush=True,
