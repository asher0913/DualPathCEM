...
RESULTS_ROOT = ROOT / "outputs" / "dual_path_publication"
LOG_ROOT = ROOT / "outputs" / "logs" / "dual_path_publication"
STATE_PATH = ROOT / "outputs" / "state" / "dual_path_publication.json"
PAPER_OUTPUT = ROOT / "outputs" / "paper_assets" / "dual_path"
